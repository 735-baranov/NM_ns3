#ifndef LORA_ZIGBEE_MAC_HEADER_H
#define LORA_ZIGBEE_MAC_HEADER_H
 ...
 */
class LoraZigBeeMacHeader : public Header
{
...
public:
   ...
   */
  enum LoraZigBeeMacType
  {
    LORAZIGBEE_MAC_BEACON = 0,        //!< LORAZIGBEE_MAC_BEACON
    LORAZIGBEE_MAC_DATA = 1,          //!< LORAZIGBEE_MAC_DATA
    LORAZIGBEE_MAC_ACKNOWLEDGMENT = 2,//!< LORAZIGBEE_MAC_ACKNOWLEDGMENT
    LORAZIGBEE_MAC_COMMAND = 3,       //!< LORAZIGBEE_MAC_COMMAND
    LORAZIGBEE_MAC_RESERVED           //!< LORAZIGBEE_MAC_RESERVED
  };
   ...
   */
  LoraZigBeeMacHeader (enum LoraZigBeeMacType wpanMacType,      // Data, ACK, Control MAC Header must have
   ...
   */
  enum LoraZigBeeMacType GetType (void) const;
  /**
   ...
   */
  void SetType (enum LoraZigBeeMacType wpanMacType);
...
#endif /* LORA_ZIGBEE_MAC_HEADER_H */
