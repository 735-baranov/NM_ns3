 ...
 */
typedef Callback< void, uint32_t, Ptr<Packet>, uint8_t > PdDataIndicationCallbackL;
...
public:
   ...
   */
  void SetPdDataIndicationCallbackL (PdDataIndicationCallbackL c);
...
private:
   ...
   */
  PdDataIndicationCallbackL m_pdDataIndicationCallbackL;
