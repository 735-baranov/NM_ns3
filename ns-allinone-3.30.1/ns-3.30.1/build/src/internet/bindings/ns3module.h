...
public:
    ...
    static PyObject * _wrap_DupAck(PyNs3TcpSocketBase *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs));
    inline void DupAck__parent_caller()
    { ns3::TcpSocketBase::DupAck(); }

    static PyObject * _wrap_EnterRecovery(PyNs3TcpSocketBase *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs));
