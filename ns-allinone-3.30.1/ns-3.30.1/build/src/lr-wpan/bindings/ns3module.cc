...
_wrap_PyNs3LrWpanPhy_SetPdDataIndicationCallback(PyNs3LrWpanPhy *self, PyObject *args, PyObject *kwargs)
{
    ...
    self->obj->SetPdDataIndicationCallbackL(ns3::Callback<void, unsigned int, ns3::Ptr<ns3::Packet>, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> (c_cb_impl));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
