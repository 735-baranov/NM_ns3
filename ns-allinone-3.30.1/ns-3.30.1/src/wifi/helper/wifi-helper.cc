...
/* NetDeviceContainer
WifiHelper::Install (NodeContainer c)
{
  ...
  for (NodeContainer::Iterator i = c.Begin (); i != c.End (); i++)
    {
      ...
      Ptr<WifiNetDevice> netDevice = CreateObject<WifiNetDevice> ();
...
WifiHelper::WifiHelper (bool useMultiModelSpectrumChannel)
{
...
void
WifiHelper::SetChannel (Ptr<SpectrumChannel> channel)
{
  m_channel = channel;
}
void
WifiHelper::SetChannel (std::string channelName)
{
