...
NS_LOG_COMPONENT_DEFINE ("wifi-zigbee-example");
...
main (int argc, char *argv[])
{
  ...
  Ptr<NetDevice> dev1 = CreateObject<NetDevice> ();
...
/* 
  ...
  Ptr<Packet> p0 = Create<Packet> (70);  // 50 байт данных
  ...
  Ptr<Packet> p2 = Create<Packet> (50);  // 60 байт данных
  params.m_dstAddr = Mac16Address ("00:01");
  dev1->GetMac ()->McpsDataRequest (params, p2);
