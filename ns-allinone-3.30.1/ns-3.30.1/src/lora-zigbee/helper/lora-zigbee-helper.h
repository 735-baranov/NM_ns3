...
class LoraZigBeeHelper : public PcapHelperForDevice,
...
public:
  ...
  /**
   * Helper to enable all LoraZigBee log components with one statement
   */
  void EnableLogComponents (void);

  /**
   * \brief Transform the LoraZigBeePhyEnumeration enumeration into a printable string.
   * \param e the LoraZigBeePhyEnumeration
   * \return a string
   */
  static std::string LoraZigBeePhyEnumerationPrinter (LoraZigBeePhyEnumeration e);

  /**
   * \brief Transform the LoraZigBeeMacState enumeration into a printable string.
   * \param e the LoraZigBeeMacState
   * \return a string
   */
  static std::string LoraZigBeeMacStatePrinter (LoraZigBeeMacState e);
