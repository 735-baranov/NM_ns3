...
{
  SetType (LORAZIGBEE_MAC_DATA);     // Assume Data frame
...
LoraZigBeeMacHeader::LoraZigBeeMacHeader (enum LoraZigBeeMacType wpanMacType,
                                  uint8_t seqNum)
{
  SetType (wpanMacType);
  SetSeqNum (seqNum);
...
enum LoraZigBeeMacHeader::LoraZigBeeMacType
LoraZigBeeMacHeader::GetType (void) const
{
  switch (m_fctrlFrmType)
    {
    case 0:
      return LORAZIGBEE_MAC_BEACON;
      break;
    case 1:
      return LORAZIGBEE_MAC_DATA;
      break;
    case 2:
      return LORAZIGBEE_MAC_ACKNOWLEDGMENT;
      break;
    case 3:
      return LORAZIGBEE_MAC_COMMAND;
      break;
    default:
      return LORAZIGBEE_MAC_RESERVED;
    }
}
...
uint16_t
LoraZigBeeMacHeader::GetFrameControl (void) const
{
  uint16_t val = 0;
...
bool
LoraZigBeeMacHeader::IsSecEnable (void) const
{
  return (m_fctrlSecU == 1);
}

bool
LoraZigBeeMacHeader::IsFrmPend (void) const
{
  return (m_fctrlFrmPending == 1);
}

bool
LoraZigBeeMacHeader::IsAckReq (void) const
{
  return (m_fctrlAckReq == 1);
}

bool
LoraZigBeeMacHeader::IsPanIdComp (void) const
{
  return (m_fctrlPanIdComp == 1);
}

uint8_t
LoraZigBeeMacHeader::GetFrmCtrlRes (void) const
{
  return (m_fctrlReserved);
}

uint8_t
LoraZigBeeMacHeader::GetDstAddrMode (void) const
{
  return m_fctrlDstAddrMode;
}

uint8_t
LoraZigBeeMacHeader::GetFrameVer (void) const
{
  return m_fctrlFrmVer;
}

uint8_t
LoraZigBeeMacHeader::GetSrcAddrMode (void) const
{
...
uint8_t
LoraZigBeeMacHeader::GetSeqNum (void) const
{
  return(m_SeqNum);
}
...
uint16_t
LoraZigBeeMacHeader::GetDstPanId (void) const
{
...
Mac16Address
LoraZigBeeMacHeader::GetShortDstAddr (void) const
{
  return(m_addrShortDstAddr);
}
Mac64Address
LoraZigBeeMacHeader::GetExtDstAddr (void) const
{
  return(m_addrExtDstAddr);
}

uint16_t
LoraZigBeeMacHeader::GetSrcPanId (void) const
{
...
Mac16Address
LoraZigBeeMacHeader::GetShortSrcAddr (void) const
{
  return(m_addrShortSrcAddr);
}
Mac64Address
LoraZigBeeMacHeader::GetExtSrcAddr (void) const
{
...
uint8_t
LoraZigBeeMacHeader::GetSecControl (void) const
{
  uint8_t val = 0;
...
uint32_t
LoraZigBeeMacHeader::GetFrmCounter (void) const
{
  return(m_auxFrmCntr);
}

uint8_t
LoraZigBeeMacHeader::GetSecLevel (void) const
{
  return (m_secctrlSecLevel);
}

uint8_t
LoraZigBeeMacHeader::GetKeyIdMode (void) const
{
  return(m_secctrlKeyIdMode);
}

uint8_t
LoraZigBeeMacHeader::GetSecCtrlReserved (void) const
{
  return (m_secctrlReserved);
}

uint32_t
LoraZigBeeMacHeader::GetKeyIdSrc32 (void) const
{
  return(m_auxKeyIdKeySrc32);
}

uint64_t
LoraZigBeeMacHeader::GetKeyIdSrc64 (void) const
{
...
uint8_t
LoraZigBeeMacHeader::GetKeyIdIndex (void) const
{
...
bool
LoraZigBeeMacHeader::IsBeacon (void) const
{
  return(m_fctrlFrmType == LORAZIGBEE_MAC_BEACON);
}



bool
LoraZigBeeMacHeader::IsData (void) const
{
  return(m_fctrlFrmType == LORAZIGBEE_MAC_DATA);
}



bool
LoraZigBeeMacHeader::IsAcknowledgment (void) const
{
  return(m_fctrlFrmType == LORAZIGBEE_MAC_ACKNOWLEDGMENT);
}



bool
LoraZigBeeMacHeader::IsCommand (void) const
{
  return(m_fctrlFrmType == LORAZIGBEE_MAC_COMMAND);
}



void
LoraZigBeeMacHeader::SetType (enum LoraZigBeeMacType wpanMacType)
{
...
void
LoraZigBeeMacHeader::SetFrameControl (uint16_t frameControl)
{
...
void
LoraZigBeeMacHeader::SetSecEnable (void)
{
  m_fctrlSecU = 1;
}
...
void
LoraZigBeeMacHeader::SetSecDisable (void)
{
  m_fctrlSecU = 0;
}
...
void
LoraZigBeeMacHeader::SetFrmPend (void)
{
  m_fctrlFrmPending = 1;
}
...
void
LoraZigBeeMacHeader::SetNoFrmPend (void)
{
  m_fctrlFrmPending = 0;
}
...
void
LoraZigBeeMacHeader::SetAckReq (void)
{
  m_fctrlAckReq = 1;
}
...
void
LoraZigBeeMacHeader::SetNoAckReq (void)
{
  m_fctrlAckReq = 0;
}
...
void
LoraZigBeeMacHeader::SetPanIdComp (void)
{
  m_fctrlPanIdComp = 1;
}


void LoraZigBeeMacHeader::SetNoPanIdComp (void)
{
  m_fctrlPanIdComp = 0;
}

void
LoraZigBeeMacHeader::SetFrmCtrlRes (uint8_t res)
{
  m_fctrlReserved = res;
}

void
LoraZigBeeMacHeader::SetDstAddrMode (uint8_t addrMode)
{
...
void
LoraZigBeeMacHeader::SetFrameVer (uint8_t ver)
{
  m_fctrlFrmVer = ver;
}
...
void
LoraZigBeeMacHeader::SetSrcAddrMode (uint8_t addrMode)
{
...
void
LoraZigBeeMacHeader::SetSeqNum (uint8_t seqNum)
{
  m_SeqNum = seqNum;
}

void
LoraZigBeeMacHeader::SetSrcAddrFields (uint16_t panId,
                                   Mac16Address addr)
{
...
void
LoraZigBeeMacHeader::SetDstAddrFields (uint16_t panId,
                                   Mac16Address addr)
{
...
void
LoraZigBeeMacHeader::SetSecControl (uint8_t secControl)
{
...
void
LoraZigBeeMacHeader::SetFrmCounter (uint32_t frmCntr)
{
  m_auxFrmCntr = frmCntr;
}

void
LoraZigBeeMacHeader::SetSecLevel (uint8_t secLevel)
{
  m_secctrlSecLevel = secLevel;
}

void
LoraZigBeeMacHeader::SetKeyIdMode (uint8_t keyIdMode)
{
  m_secctrlKeyIdMode = keyIdMode;
}

void
LoraZigBeeMacHeader::SetSecCtrlReserved (uint8_t res)
{
  m_secctrlReserved = res;
}

void
LoraZigBeeMacHeader::SetKeyId (uint8_t keyIndex)
{
...
void
LoraZigBeeMacHeader::SetKeyId (uint32_t keySrc,
                           uint8_t keyIndex)
{
  m_auxKeyIdKeyIndex = keyIndex;
...
void
LoraZigBeeMacHeader::SetKeyId (uint64_t keySrc,
                           uint8_t keyIndex)
{
  m_auxKeyIdKeyIndex = keyIndex;
